        ...
        <div className="bg-gray-50 rounded-xl px-4 py-3 space-y-1 text-sm">
          {needsFx && (
            <div className="flex justify-between text-gray-500">
              ...
              <span>{totalAssetCurrency.toLocaleString(getIntlLocale(i18n.language), { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {priceCurrency}</span>
            </div>
          )}
          {fee > 0 && (
            <div className="flex justify-between text-gray-500">
              ...
              <span className={feeSign > 0 ? "text-red-500" : "text-gray-500"}>
                {feeSign > 0 ? "+" : "−"} € {fee.toLocaleString(getIntlLocale(i18n.language), { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              </span>
            </div>
          )}
          <div className="flex justify-between font-semibold text-gray-900 pt-1 border-t border-gray-200">
            <span>{txType === "BUY" ? t("transactionForm.totalCost") : t("transactionForm.totalNet")}</span>
            <span>€ {totalEur.toLocaleString(getIntlLocale(i18n.language), { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
          </div>
